...
# -*- coding: utf-8 -*-
"""
Start the Skin Disease Diagnosis Application Server
...
def start_server():
    ...
    print(" Starting Skin Disease Diagnosis Application Server...")
    print(" Server will be available at: http://localhost:8001")
    print(" API documentation at: http://localhost:8001/docs")
    print(" Main interface at: http://localhost:8001")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("main.py"):
        ...
        print("Please run this script from the skin-diagnosis-app directory")
        sys.exit(1)

    # Check if virtual environment is active (optional check)
    if not hasattr(sys, 'real_prefix') and not (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix):
        print("WARNING:  Warning: Virtual environment may not be active")
